...
- (id)initWithMoviePlayer:(ALMoviePlayerController *)moviePlayer style:(ALMoviePlayerControlsStyle)style {
    ...
    if (self) {
        ...
        _barColor = [[UIColor whiteColor] colorWithAlphaComponent:0.5];
        ...
        _barHeight = [UIDevice iOSVersion] >= 7.0 ? 40.f : 30.f;
...
- (void)setup {
    ...
    [_durationSlider setThumbImage:[UIImage imageNamed:@"track_normal.png"] forState:UIControlStateNormal];
    [_durationSlider setThumbImage:[UIImage imageNamed:@"track.png"] forState:UIControlStateHighlighted];
    [_durationSlider setMaximumTrackImage:[UIImage imageNamed:@"transprent.png"] forState:UIControlStateNormal];
    
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 5.0) {
        [_durationSlider setMinimumTrackImage:[[UIImage imageNamed:@"progress_video.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:8] forState:UIControlStateNormal];
        
        [_durationSlider setMaximumTrackImage:[[UIImage imageNamed:@"progress_video.png"] stretchableImageWithLeftCapWidth:2 topCapHeight:2] forState:UIControlStateNormal];
    }
    ...
    if (_style == ALMoviePlayerControlsStyleFullscreen || (_style == ALMoviePlayerControlsStyleDefault && _moviePlayer.isFullscreen)) {
       ...
       // [_fullscreenButton setTitle:@"Done" forState:UIControlStateNormal];
         [_fullscreenButton setBackgroundImage:[UIImage imageNamed:@"movieFullscreen.png"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    CGFloat airplayWidth = 30.f; //no used
    CGFloat airplayHeight = 22.f;
    CGFloat playWidth = 18.f;
    CGFloat playHeight = 15.f;
